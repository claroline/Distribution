...
class ExerciseImporter extends Importer implements RichTextInterface
{
    ...
    public function format($data)
    {
        ...
        $exercise = $this->container->get('ujm_exo.serializer.exercise')->deserialize($quizData, $exercise, [Transfer::USE_SERVER_IDS]);

        $this->container->get('claroline.persistence.object_manager')->persist($exercise);
    }
