    ...
    return (
      <div className="panel panel-default panel-analytics">
          ...
          <div className="panel-body">
            ...
            >
              <g transform="translate(-25, -25)">
                ...
                <text fontSize="40" transform="translate(5, 40)" fill="#444444">
                  <tspan className="fa fa-folder">&#xf07b;</tspan>
                </text>
              </g>
            </PieChart>
          </div>
        ...
        {this.props.loaded && 'list' === this.props.mode &&
          ...
          >
            <DataTable
              count={chartData.reduce((total, current) => total + current.yData, 0)}
              data={chartData
                .map((data, idx) => ({
                  id: data.xData,
                  color: schemeCategory20c[idx % schemeCategory20c.length],
                  type: trans(data.xData, {}, 'resource'),
                  count: data.yData
                }))
                .sort((a, b) => {
...
ResourcesChart.propTypes = {
  ...
  fetchResources: T.func.isRequired
}
