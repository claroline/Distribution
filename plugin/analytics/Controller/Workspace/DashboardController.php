...
class DashboardController
{
    ...
    /**
     * @EXT\Route("/{workspace}/progression/export", name="apiv2_workspace_export_progression")
     * @EXT\Method("GET")
     * @EXT\ParamConverter("workspace", class="Claroline\CoreBundle\Entity\Workspace\Workspace", options={"mapping": {"workspace": "uuid"}})
     */
    public function exportProgressionAction(Workspace $workspace)
    {
        ...
        return new StreamedResponse(function () use ($workspace, $workspaceEvaluations) {
            ...
            foreach ($workspaceEvaluations as $workspaceEvaluation) {
                ...
                fputcsv($handle, [
                    ...
                    ($workspaceEvaluation->getScore() / $workspaceEvaluation->getScoreMax()) * 100,
                ], ';', '"');
            }
    ...
    /**
     * @EXT\Route("/{workspace}/progression/export/{user}", name="apiv2_workspace_export_user_progression")
     * @EXT\Method("GET")
     * @EXT\ParamConverter("user", class="Claroline\CoreBundle\Entity\User", options={"mapping": {"user": "uuid"}})
     * @EXT\ParamConverter("workspace", class="Claroline\CoreBundle\Entity\Workspace\Workspace", options={"mapping": {"workspace": "uuid"}})
     *
