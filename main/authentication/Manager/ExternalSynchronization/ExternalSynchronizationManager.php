...
use Claroline\AuthenticationBundle\Repository\ExternalSynchronization\ExternalResourceSynchronizationRepository;
...
class ExternalSynchronizationManager
{
    ...
    public function syncrhonizeAllGroupsForExternalSource($sourceName, $forceUnsubscribe = true)
    {
        ...
        $this
            ->om
            ->getRepository('ClarolineAuthenticationBundle:ExternalSynchronization\ExternalGroup')
