...
namespace Claroline\AuthenticationBundle\Security\Cas;

use Claroline\AppBundle\Persistence\ObjectManager;
use Claroline\AuthenticationBundle\Entity\Cas\CasUser;
use Claroline\AuthenticationBundle\Repository\Cas\CasUserRepository;
...
class CasUserProvider implements UserProviderInterface
{
    ...
    public function __construct(
        ...
        $this->casUserRepo = $om->getRepository('ClarolineAuthenticationBundle:Cas\CasUser');
