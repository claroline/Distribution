...
class ConfigurationCheckerTest extends MockeryTestCase
{
    ...
    protected function setUp()
    {
        ...
        $resourceTypeRepo = $this->mock('Claroline\CoreBundle\Repository\Service\ResourceTypeRepository');
        $resourceTypeRepo->shouldReceive('findAll')->andReturn([]);
        $toolRepo = $this->mock('Claroline\CoreBundle\Repository\Service\ResourceTypeRepository');
