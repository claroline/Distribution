 ...
 * This should be removed for the next major version (13).
 *
 * @DI\Service("claroline.serializer.legacy_parameters")
 */
    ...
    public function serialize(array $options = [])
    {
        ...
        $serialized = [
            ...
            'tos' => [
                ...
                'text' => in_array(Options::SERIALIZE_MINIMAL, $options) ? [] : $this->serializeTos(),
            ],
            'registration' => [
