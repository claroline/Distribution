  ...
  <div className="widgets-grid">
        ...
        actions={[
          {
            ...
            label: trans('add_container_before', {}, 'widget'),
            ...
            dangerous: true,
            confirm: {
              title: trans('container_delete_confirm_title', {}, 'widget'),
              message: trans('container_delete_confirm_message', {}, 'widget')
            },
            callback: () => {
    ...
    {0 === props.widgets.length &&
      <EmptyPlaceholder
        size="lg"
        icon="fa fa-frown-o"
        title={trans('no_container', {}, 'widget')}
      />
    }
    ...
    <Button
      ...
      type="modal"
      label={trans('add_container', {}, 'widget')}
      modal={[MODAL_WIDGET_CREATION, {
