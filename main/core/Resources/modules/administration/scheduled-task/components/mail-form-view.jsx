...
class MailFormView extends Component {
  constructor(props) {
    super(props)
    this.state = {
      hasError: false,
...
const ConnectedMailFormView = connect(mapStateToProps, mapDispatchToProps)(MailFormView)

export {ConnectedMailFormView as MailFormView}