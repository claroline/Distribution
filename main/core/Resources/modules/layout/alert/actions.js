...
actions.addAlert = (id, status, action = constants.ACTION_GENERIC, message = null, title = null) => {
  // validates params
  ...
  invariant(Object.keys(actionConstants.ALERT_ACTIONS[action][status]), 'action does not implement the alert status')
