...
import {UserTab} from '#/main/core/tools/community/user/components/user-tab'
import {GroupTab} from '#/main/core/tools/community/group/components/group-tab'
import {RoleTab} from '#/main/core/tools/community/role/components/role-tab'
import {ParametersTab} from '#/main/core/tools/community/parameters/components/parameters-tab'
import {PendingTab} from '#/main/core/tools/community/pending/components/pending-tab'
...
const UsersTool = (props) => {
  ...
  const regExp = new RegExp('/desktop/community/profile/([^/]*)')
        ...
        routes={[
          {
            path: '/users',
            component: UserTab,
            disabled: props.context === toolConstants.TOOL_WORKSPACE && get(props.workspace, 'meta.model')
          }, {
            path: '/groups',
            component: GroupTab,
            disabled:  props.context !== toolConstants.TOOL_WORKSPACE && get(props.workspace, 'meta.model')
