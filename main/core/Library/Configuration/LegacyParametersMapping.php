...
class LegacyParametersMapping
{
    public function getMapping()
    {
        return [
            ...
            'username_regex' => 'security.username_regex',
            ...
            'help_url' => 'help.url',
            'register_button_at_login' => 'security.register_button_at_login',
            ...
            'workspace_list_default_mode' => 'workspace.list.default_mode-sm',
